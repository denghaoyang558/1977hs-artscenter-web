...
<link href="/1977hs/Public/Css/works_secai.css" rel="stylesheet">
    ...
    <div class="rectangle">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php if(is_array($works)): foreach($works as $key=>$data): ?><div class="col-md-4">
              <a href="#" onclick="myModalImage('/1977hs<?php echo ($data["pic_adr"]); ?>')">
                <div class="pic">
                  <img src="/1977hs<?php echo ($data["pic_adr"]); ?>" width="350" height="240">
                </div>
              </a>
