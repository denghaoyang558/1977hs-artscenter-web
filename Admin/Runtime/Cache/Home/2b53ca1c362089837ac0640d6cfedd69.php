    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="active">修改师资</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Strength/alter_teacher_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  <td>职称：</td>
                  <td><input name="position" type="text" class="form-control" style="width:320px;" value="<?php echo ($position); ?>" placeholder="请输入职称（可不填）"></td>
                </tr>
                <tr>
                  <td>当前图片:</td>
                ...
                <tr>
                  <td>师资介绍:</td>
                  <td><textarea name="content" class="form-control" rows="3" placeholder="请输入师资介绍"><?php echo ($content); ?></textarea></td>
                </tr>
              </tbody>
            </table>
