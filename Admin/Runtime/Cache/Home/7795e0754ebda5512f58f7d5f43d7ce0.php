    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
              ...
              <li class="active">修改教学环境图片</li>
            </ol>
        </div>
    </div>
    <form class="form-signin" enctype="multipart/form-data" role="form" action="<?php echo U('Strength/alter_environment_picture_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>当前图片:</td>
                  <td><a href="#" onclick="callmyModal_1('/1977hs<?php echo ($environment_picture["pic_adr"]); ?>');"><img src="/1977hs<?php echo ($environment_picture["pic_adr"]); ?>" class="img-thumbnail" style="height:200px;width:200px;float:left;"/></a></td>
                </tr>
                <tr>
                  <td>上传新的图片:</td>
            ...
            <input name="id" value="<?php echo ($environment_picture["id"]); ?>" type="hidden" >
