...
<div id="page-wrapper" >
    ...
    <form class="form-signin" role="form" action="<?php echo U('Friend/alter_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  <td>名称:</td>
                  <td><input name="name" type="text" class="form-control" style="width:320px;" placeholder="请输入名称" value="<?php echo ($friend["name"]); ?>"></td>
                </tr>
                <tr>
                  <td>URL:</td>
                  <td><textarea name="url" class="form-control" rows="3" placeholder="请输入URL"><?php echo ($friend["url"]); ?></textarea></td>
                </tr>
              </tbody>
            </table>
            <input name="id" value="<?php echo ($friend["id"]); ?>" type="hidden">
