<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
  ...
  <head>
    ...
    <link href="/1977hs/Public/Css/admin/dashboard.css" rel="stylesheet">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <img src="/1977hs/Public/Uploads/img/songyaodong.jpg" class="img-rounded" style="width:570px;">
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="myModal_3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <img src="/1977hs/Public/Uploads/img/scrollleft/1.jpg" class="img-rounded" style="width:570px;">
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="myModal_5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <img src="/1977hs/Public/Uploads/img/pic/1.jpeg" class="img-rounded" style="width:570px;">
      </div>
    </div>
  </div>
</div>
