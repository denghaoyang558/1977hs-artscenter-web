...
<div id="page-wrapper" >
    ...
    <form class="form-signin" role="form" action="<?php echo U('Consultus/alter_handle');?>" method='post' id="form">
    <!-- 主体 -->
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered">
              <tbody>
                <tr>
                  ...
                  <td><input name="title" type="text" class="form-control" style="width:320px;" placeholder="请输入文章标题" value="<?php echo ($consult["title"]); ?>"></td>
                </tr>
                <tr>
                  <td><div style="margin-top:6px">简介:</div></td>
                  <td><textarea name="introduction" class="form-control" rows="3" placeholder="请输入文章简介"><?php echo ($consult["introduction"]); ?></textarea></td>
                </tr>
                <tr>
                  <td>内容:</td>
                  <td>
            ...
            <input name="id" value="<?php echo ($consult["id"]); ?>" type="hidden">
